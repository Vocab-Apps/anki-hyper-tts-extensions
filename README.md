...
# Refreshing the OpenRouter voice list

OpenRouter is a gateway to hundreds of AI models. Available models are updated frequently. The OpenRouter service reads the available models from `services/openrouter_voices.json`. You can refresh this data automatically via the included Python script.
